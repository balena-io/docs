...
__Warning:__ Resin sync directly copies files from your local machine to the container. It does not run any of the commands in the Docker file. This means that any changes to `.rs` files will **NOT** take effect as the code is not re-compiled.
