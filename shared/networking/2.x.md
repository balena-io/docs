...
We use **[redsocks][redsocks]** to connect your to device to resin.io from behind a proxy. To enable, a [redsocks.conf][redsocks-conf-example] file should be added at `/mnt/boot/system-proxy/`, specifying the needed proxy configuration and ensuring that:
