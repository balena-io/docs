...
| 2.0.0+rev2-standalone | standalone | This version is an unmanaged version of resinOS, it doesn't have the resin.io supervisor and does not connect to the management console. Use this variant if you want a stable linux OS to run Docker on. |
