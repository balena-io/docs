...
Insert the SD card into the {{ $device_details.name }} and connect either the ethernet cable if necessary. Now power up the {{ $device_details.name }} by inserting the micro USB cable.
