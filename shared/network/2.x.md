...
Please note that, sometimes, with a privileged container, the container will start udev and this will conflict with the host, usually breaking cellular connectivity. Our base images allow setting ENV UDEV off to turn udev off, which would fix this.
