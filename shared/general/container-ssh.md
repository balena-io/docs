...
The IP address will typically be a private IP address of a local network. For remote devices, see [balena device tunnel](../../learn/manage/ssh-access/#balena-tunnel).
...
See note in the [previous section](container-ssh.md#using-a-standalone-ssh-client) regarding the username (`root` _vs._ balenaCloud user account).
