...
`resin-data` is the partition that holds downloaded Docker images. Generally any container data will be found here. If you want to read a bit more about the partition layout, have a look at the [{{ $names.os.lower }} github repo]({{ $links.githubOS }}/meta-balena/blob/master/meta-resin-common/classes/image_types_resin.bbclass#L20).
