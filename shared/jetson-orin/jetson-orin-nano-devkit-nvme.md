...
By default, most Jetson Orin devices need an internal storage media and a USB flash drive in order to be provisioned. On the Jetson Orin Nano Devkit, an NVMe drive has to be attached to the
