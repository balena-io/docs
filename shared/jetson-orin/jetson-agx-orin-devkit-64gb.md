...
<br>
<b>A Display Port cable or Display Port to HDMI adapter is necessary for connecting your Jetson AGX Orin Devkit 64GB to a monitor.</b> Once the monitor is attached, the UEFI firmware version will be displayed at the top of the screen:
