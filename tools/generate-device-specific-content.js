...
function prepareInstructions(instructions) {
  ...
  if (etcherIndex !== -1) {
    instructions.splice(etcherIndex + 1, 0, `<img src="../../.gitbook/assets/etcher-flashing.gif" alt="etcher flashing">`)
  }
  ...
  if (sdCardIndex !== -1) {
    instructions.splice(sdCardIndex + 1, 0, `<img src="../../.gitbook/assets/insert-sd.gif" alt="insert SD card">`)
  }
