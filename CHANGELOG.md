...
* workflows: Add externals to source control [Kyle Harding]
* workflows: Skip prepare step during builds and link-checker [Kyle Harding]
* workflows: Automatically fetch external markdown files and open a PR [Kyle Harding]
