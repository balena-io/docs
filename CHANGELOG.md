...
* Update dependency wrangler to v3.114.17 [SECURITY] [balena-renovate[bot]]

## 6.14.0 - 2026-01-26

* Add version-pinned external documentation [Kyle Harding]
* feat: replace fetch-external.sh with version-pinned sync system [Kyle Harding]

## 6.13.6 - 2026-01-19

* Update billing page screenshots [joshbwlng]

## 6.13.5 - 2026-01-05

* Update algolia search key [Matthew Yarmolinsky]

## 6.13.4 - 2026-01-05

* Fix search not working due to rotated API key [Matthew Yarmolinsky]

## 6.13.3 - 2025-12-19

* Add docs for `sw.os` and `sw.kernel` container contract label types [Christina Ying Wang]

## 6.13.2 - 2025-12-17

* Remove all flags except `--config` from `balena os configure` example [Matthew Yarmolinsky]
