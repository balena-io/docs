...
Enter a fleet name, select the **Blue Chip Technology DB1** device type, choose the _Starter_ [fleet type](../accounts/fleet-types.md), and click **Create new fleet**:
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-bluechiptechnology-db1-6.10.24-v17.4.2.img.zip`.
...
* Insert the freshly flashed SD card into the Blue Chip Technology DB1.
* **Warning!** This will also completely erase internal storage medium, so please make a backup first.
* Connect power to the Blue Chip Technology DB1
* Wait for the Blue Chip Technology DB1 to finish flashing and shutdown. Please wait until Screen and ethernet green LED are off.
* Remove the SD card from the Blue Chip Technology DB1.
* Remove and re-connect power to the Blue Chip Technology DB1 to boot the device.

When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Blue Chip Technology DB1](../faq/troubleshooting/bluechiptechnology-db1/) or try our [support channels](../accounts/support-access.md).
