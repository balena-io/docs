...
* To provision CTI Photon Xavier NX, follow the instructions using our [Jetson Flash tool](https://github.com/balena-os/jetson-flash/blob/master/docs/photon-xavier-nx.md) to make the process more streamlined.
