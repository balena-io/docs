# Troubleshooting information for Raspberry Pi 3 (using 64bit OS)
...
The inability to boot your Raspberry Pi 3 may be related to the hardware revision used. RaspberryPi 3B+ Rev9 is supported by firmware versions from September 2021 onwards. Thus, balenaOS releases at v2.101.7 or newer are expected to work with this hardware revision because they use an updated firmware.
