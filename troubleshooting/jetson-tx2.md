# Troubleshooting information for Nvidia Jetson TX2
...
With balenaOS 2.47, the [Tegra Linux Driver Package](https://developer.nvidia.com/embedded/linux-tegra) (L4T) was upgraded to version 32.2 from a previous version of 28.x. Trying to flash a board that was previously running L4T 28.x with an SD card containing L4T 32.2 or newer will fail. This failure happens because L4T 32.2 and newer kernels are incompatible with the eMMC partitions from L4T 28.x, and vice-versa.

To resolve, either:

- Perform a [self-service update](/reference/OS/updates/self-service/) to update balenaOS to >=2.47.
