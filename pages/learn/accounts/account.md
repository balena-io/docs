...
To add a password to an account created with a social login (Google, Github), navigate to the \[_Preferences_]\[prefs] page found by clicking on your profile in the top right of the dashboard. Under the _Account details_ tab you can set a password for your account.
...
**Note:** We use the industry standard [Time-based One-time Password Algorithm](https://en.wikipedia.org/wiki/Time-based_One-time_Password_Algorithm) to implement this functionality.
...
\[signup]:https://dashboard.balena-cloud.com/signup \[login]:https://dashboard.balena-cloud.com/login \[prefs]:https://dashboard.balena-cloud.com/preferences?tab=details \[password-reset]:https://dashboard.balena-cloud.com/password-reset \[privacy-policy]:https://balena.io/privacy-policy/
