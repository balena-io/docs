...
__Note__: It is currently not possible to specify the application or device release policy via the {{ $names.cli }}.
...
[masterclass]:https://github.com/balena-io-projects/balena-fleet-management-masterclass/blob/master/README.md#6-Release-Policy
