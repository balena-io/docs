...
We recommend [Pi Pins][pi-pins] for node.js projects - we've found it works reliably on [{{ $names.company.upper }}][balena]. Check out our [example GPIO application][example-gpio-app] which uses this library.
