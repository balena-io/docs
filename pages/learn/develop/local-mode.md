...
- Local mode must be enabled through the {{ $names.cloud.lower }} dashboard. You can enable it from the *Settings* page. Find the *Settings* on the device dashboard menu. 
