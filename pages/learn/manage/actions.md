...
2. Ask an administrator of the **target** balenaCloud organization to create a new empty application using the same application name (the [application type][app-types] doesn't need to match).
