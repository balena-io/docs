...
* Power: Not all power supplies are fully compatible with all boards (especially USB-based supplies). It is important to confirm that the power supply is capable and actually providing the required power before widespread deployment.
