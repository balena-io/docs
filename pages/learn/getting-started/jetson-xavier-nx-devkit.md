...
Enter a fleet name, select the **Nvidia Jetson Xavier NX Devkit SD-CARD** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
