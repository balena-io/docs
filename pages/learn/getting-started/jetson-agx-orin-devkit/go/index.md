...
Enter a fleet name, select the **Nvidia Jetson AGX Orin Devkit 32GB** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
