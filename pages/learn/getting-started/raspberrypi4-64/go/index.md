...
Enter a fleet name, select the **Raspberry Pi 4 (using 64bit OS)** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
