# Getting Started: Raspberry Pi Zero 2 W (64bit) and Go
...
Enter a fleet name, select the **Raspberry Pi Zero 2 W (64bit)** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Raspberry Pi Zero 2 W (64bit)](/faq/troubleshooting/raspberrypi0-2w-64) or try our [support channels](/support/).
