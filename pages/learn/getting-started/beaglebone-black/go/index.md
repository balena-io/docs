# Getting Started: BeagleBone Black and Go
...
<img style="float: right;padding-left: 10px;" src="/img/beaglebone-black/beaglebone-black.webp" width="25%">
...
* An ethernet cable or [WiFi adapter](/hardware/wifi-dongles/) to connect your device to the
...
Enter a fleet name, select the **BeagleBone Black** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for BeagleBone Black](/faq/troubleshooting/beaglebone-black) or try our [support channels](/support/).
