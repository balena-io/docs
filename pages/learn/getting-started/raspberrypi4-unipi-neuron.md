...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for UniPi Neuron (Raspberry Pi 4)](/faq/troubleshooting/raspberrypi4-unipi-neuron) or try our [support channels](../../learn/accounts/support-access.md).
