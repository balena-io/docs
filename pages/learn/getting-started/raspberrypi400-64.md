...
Enter a fleet name, select the **Raspberry Pi 400** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Raspberry Pi 400](/faq/troubleshooting/raspberrypi400-64) or try our [support channels](../../learn/accounts/support-access.md).
