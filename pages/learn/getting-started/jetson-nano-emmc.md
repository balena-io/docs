 ...
 * A [Nvidia Jetson Nano eMMC](https://developer.nvidia.com/embedded/jetson-nano) and it's devkit carrier board. See our [supported devices list](../../reference/hardware/devices.md) for other boards.
