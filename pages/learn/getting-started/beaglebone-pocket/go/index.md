# Getting Started: PocketBeagle and Go

In this guide, we will help you get started with balenaCloud by:

- Setting up your **PocketBeagle** device and bringing it online on the balenaCloud dashboard.
...
* Your PocketBeagle device you want to get started with. Check out all of our [supported devices](/reference/hardware/devices/).
...
Enter a fleet name, select the **PocketBeagle** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:

<img src="/img/getting-started/create-fleet.webp" width="80%">

You'll then be redirected to the summary of the newly created fleet, where you can add your first PocketBeagle.
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-beaglebone-pocket-2.80.3+rev1-v12.7.0.img.zip`.
...
98264 First-Fleet  balena CLI/first-fleet    PocketBeagle    0              0
```
