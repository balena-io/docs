...
Enter a fleet name, select the **Seeed reComputer J3010 Jetson Orin Nano 4GB** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
