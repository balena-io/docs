...
Enter a fleet name, select the **Blue Chip Technology TM3** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
