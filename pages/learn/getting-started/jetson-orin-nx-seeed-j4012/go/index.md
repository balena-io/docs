...
Enter a fleet name, select the **Seeed reComputer J4012 (Classic) Jetson Orin NX 16GB** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
