# Getting Started: Revolution Pi Connect and Go

In this guide, we will help you get started with balenaCloud by:

- Setting up your **Revolution Pi Connect** device and bringing it online on the balenaCloud dashboard.
...
* Your Revolution Pi Connect device you want to get started with. Check out all of our [supported devices](/reference/hardware/devices/).
...
Enter a fleet name, select the **Revolution Pi Connect** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:

<img src="/img/getting-started/create-fleet.webp" width="80%">

You'll then be redirected to the summary of the newly created fleet, where you can add your first Revolution Pi Connect.
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-revpi-connect-2.80.3+rev1-v12.7.0.img.zip`.
...
While not having the Revolution Pi Connect board powered, connect your system to the board&#x27;s USB port via a micro-USB cable. Power on the Revolution Pi Connect.,Write the balenaOS file you downloaded to the Revolution Pi Connect. We recommend using &lt;a href&#x3D;&quot;https://etcher.balena.io/&quot;&gt;Etcher&lt;/a&gt;.,Wait for writing of balenaOS to complete.,Power off the Revolution Pi Connect and unplug the micro-USB cable,Remove and re-connect power to the Revolution Pi Connect to boot the device.

When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Revolution Pi Connect](/faq/troubleshooting/revpi-connect) or try our [support channels](/support/).
...
98264 First-Fleet  balena CLI/first-fleet    Revolution Pi Connect    0              0
```
