...
Next, we will flash the downloaded image onto the device. To do so, follow the following steps:
  ...
  * To provision CTI Photon TX2 NX, follow the instructions using our [Jetson Flash tool](https://github.com/balena-os/jetson-flash/blob/master/docs/photon-tx2-nx.md) to make the process more streamlined.
