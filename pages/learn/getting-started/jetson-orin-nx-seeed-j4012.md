...
* Your Seeed reComputer J4012 (Classic) Jetson Orin NX 16GB device you want to get started with. Check out all of our [supported devices](../../reference/hardware/devices.md).
...
Enter a fleet name, select the **Seeed reComputer J4012 (Classic) Jetson Orin NX 16GB** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
