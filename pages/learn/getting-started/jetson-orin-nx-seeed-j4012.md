...
Enter a fleet name, select the **Seeed reComputer J4012 (Classic) Jetson Orin NX 16GB** device type, choose the _Starter_ [fleet type](../accounts/fleet-types.md), and click **Create new fleet**:
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-jetson-orin-nx-seeed-j4012-6.10.24-v17.4.2.img.zip`.
