...
Enter a fleet name, select the **Generic x86_64 (legacy MBR)** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
