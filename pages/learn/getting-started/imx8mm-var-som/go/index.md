# Getting Started: Variscite VAR-SOM-MX8M-MINI Devkit and Go
...
Enter a fleet name, select the **Variscite VAR-SOM-MX8M-MINI Devkit** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Variscite VAR-SOM-MX8M-MINI Devkit](/faq/troubleshooting/imx8mm-var-som) or try our [support channels](/support/).
