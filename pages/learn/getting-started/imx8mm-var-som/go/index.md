...
Enter a fleet name, select the **Variscite VAR-SOM-MX8M-MINI Devkit** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
