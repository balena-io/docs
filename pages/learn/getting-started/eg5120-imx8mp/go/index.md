# Getting Started: Robustel EG5120 i.MX8MP and Go
...
Enter a fleet name, select the **Robustel EG5120 i.MX8MP** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Robustel EG5120 i.MX8MP](/faq/troubleshooting/eg5120-imx8mp) or try our [support channels](/support/).
