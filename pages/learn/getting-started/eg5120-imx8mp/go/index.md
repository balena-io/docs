...
Enter a fleet name, select the **Robustel EG5120 i.MX8MP** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
