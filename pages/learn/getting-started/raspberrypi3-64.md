...
Enter a fleet name, select the **Raspberry Pi 3 (using 64bit OS)** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
