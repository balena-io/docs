...
Enter a fleet name, select the **Forecr DSBOARD-ORNX-LAN Orin Nano 8GB** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
