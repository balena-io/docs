# Getting Started: Blue Chip Technology DB1 and Go

In this guide, we will help you get started with balenaCloud by:

- Setting up your **Blue Chip Technology DB1** device and bringing it online on the balenaCloud dashboard.
...
* Your Blue Chip Technology DB1 device you want to get started with. Check out all of our [supported devices](/reference/hardware/devices/).
...
Enter a fleet name, select the **Blue Chip Technology DB1** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:

<img src="/img/getting-started/create-fleet.webp" width="80%">

You'll then be redirected to the summary of the newly created fleet, where you can add your first Blue Chip Technology DB1.
...
balenaCloud builds a custom balenaOS image configured for Blue Chip Technology DB1 which allows the device to provision and join the new fleet you created automatically. Start by clicking **Add device** on the fleet summary. Your device type will be preselected here since you already chose it when creating the fleet. Other device types of the same [architecture](/reference/hardware/devices/) can also be picked to join the fleet.
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-bluechiptechnology-db1-2.80.3+rev1-v12.7.0.img.zip`.
...
Insert the SD card to the host machine.,Write the balenaOS file you downloaded to the SD card. We recommend using &lt;a href&#x3D;&quot;https://etcher.balena.io/&quot;&gt;Etcher&lt;/a&gt;.,Wait for writing of balenaOS to complete.,Remove the SD card from the host machine.,Insert the freshly flashed SD card into the Blue Chip Technology DB1.,&lt;strong role&#x3D;&quot;alert&quot;&gt;Warning!&lt;/strong&gt; This will also completely erase internal storage medium, so please make a backup first.,Connect power to the Blue Chip Technology DB1,Wait for the Blue Chip Technology DB1 to finish flashing and shutdown. Please wait until Screen and ethernet green LED are off.,Remove the SD card from the Blue Chip Technology DB1.,Remove and re-connect power to the Blue Chip Technology DB1 to boot the device.

When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Blue Chip Technology DB1](/faq/troubleshooting/bluechiptechnology-db1) or try our [support channels](/support/).
...
98264 First-Fleet  balena CLI/first-fleet    Blue Chip Technology DB1    0              0
```
