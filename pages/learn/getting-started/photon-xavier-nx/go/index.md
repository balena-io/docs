# Getting Started: CTI Photon Xavier NX and Go

In this guide, we will help you get started with balenaCloud by:

- Setting up your **CTI Photon Xavier NX** device and bringing it online on the balenaCloud dashboard.
...
* Your CTI Photon Xavier NX device you want to get started with. Check out all of our [supported devices](/reference/hardware/devices/).
...
Enter a fleet name, select the **CTI Photon Xavier NX** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:

<img src="/img/getting-started/create-fleet.webp" width="80%">

You'll then be redirected to the summary of the newly created fleet, where you can add your first CTI Photon Xavier NX.
...
balenaCloud builds a custom balenaOS image configured for CTI Photon Xavier NX which allows the device to provision and join the new fleet you created automatically. Start by clicking **Add device** on the fleet summary. Your device type will be preselected here since you already chose it when creating the fleet. Other device types of the same [architecture](/reference/hardware/devices/) can also be picked to join the fleet.
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-photon-xavier-nx-2.80.3+rev1-v12.7.0.img.zip`.
...
To provision CTI Photon Xavier NX, follow the instructions using our &lt;a href&#x3D;&quot;https://github.com/balena-os/jetson-flash/blob/master/docs/photon-xavier-nx.md&quot;&gt;Jetson Flash tool&lt;/a&gt; to make the process more streamlined.

When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for CTI Photon Xavier NX](/faq/troubleshooting/photon-xavier-nx) or try our [support channels](/support/).
...
98264 First-Fleet  balena CLI/first-fleet    CTI Photon Xavier NX    0              0
```
