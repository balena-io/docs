...
Next, we will flash the downloaded image onto the device. To do so, follow the following steps:
  ...
  * To provision CTI Photon Nano, follow the instructions using our [Jetson Flash tool](https://github.com/balena-os/jetson-flash/blob/master/docs/photon-nano.md) to make the process more streamlined.
