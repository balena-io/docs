# Getting Started: Nvidia Jetson Xavier and Go
...
Enter a fleet name, select the **Nvidia Jetson Xavier** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
