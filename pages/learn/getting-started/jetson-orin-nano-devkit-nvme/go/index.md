...
Enter a fleet name, select the **Nvidia Jetson Orin Nano 8GB (SD) Devkit NVME** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
