 ...
 * A [Raspberry Pi 2 model B](https://www.raspberrypi.org/products/raspberry-pi-2-model-b/). See our [supported devices list](../../reference/hardware/devices.md) for other boards.
