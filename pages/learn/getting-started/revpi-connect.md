...
Enter a fleet name, select the **Revolution Pi Connect** device type, choose the _Starter_ [fleet type](../../learn/accounts/fleet-types.md), and click **Create new fleet**:
