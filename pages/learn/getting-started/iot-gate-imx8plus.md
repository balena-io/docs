...
Enter a fleet name, select the **Compulab IOT-GATE-iMX8PLUS 2GB or 4GB DRAM** device type, choose the _Starter_ [fleet type](../accounts/fleet-types.md), and click **Create new fleet**:
