# Getting Started: Revolution Pi Core 3 and Go

In this guide, we will help you get started with balenaCloud by:

- Setting up your **Revolution Pi Core 3** device and bringing it online on the balenaCloud dashboard.
...
<img style="float: right;padding-left: 10px;" src="/img/revpi-core-3/revpi-core-3.webp" width="30%">

* A [Revolution Pi Core 3](https://revolutionpi.com/revpi-core/). See our [supported devices list](/hardware/devices/) for other boards.
...
Enter a fleet name, select the **Revolution Pi Core 3** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:

<img src="/img/getting-started/create-fleet.webp" width="80%">

You'll then be redirected to the summary of the newly created fleet, where you can add your first Revolution Pi Core 3.
...
balenaCloud builds a custom balenaOS image configured for Revolution Pi Core 3 which allows the device to provision and join the new fleet you created automatically. Start by clicking **Add device** on the fleet summary. Your device type will be preselected here since you already chose it when creating the fleet. Other device types of the same [architecture](/reference/hardware/devices/) can also be picked to join the fleet.
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-revpi-core-3-2.80.3+rev1-v12.7.0.img.zip`.
...
While not having the Revolution Pi Core 3 board powered, connect your system to the board&#x27;s USB port via a micro-USB cable. Power on the Revolution Pi Core 3.,Write the balenaOS file you downloaded to the Revolution Pi Core 3. We recommend using &lt;a href&#x3D;&quot;https://etcher.balena.io/&quot;&gt;Etcher&lt;/a&gt;.,Wait for writing of balenaOS to complete.,Power off the Revolution Pi Core 3 and unplug the micro-USB cable.,Remove and re-connect power to the Revolution Pi Core 3. to boot the device.

When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Revolution Pi Core 3](/faq/troubleshooting/revpi-core-3) or try our [support channels](/support/).
...
98264 First-Fleet  balena CLI/first-fleet    Revolution Pi Core 3    0              0
```
