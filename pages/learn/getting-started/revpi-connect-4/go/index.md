# Getting Started: Revolution Pi Connect 4 and Go
...
Enter a fleet name, select the **Revolution Pi Connect 4** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
