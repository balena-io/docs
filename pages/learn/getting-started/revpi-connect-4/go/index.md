...
Enter a fleet name, select the **Revolution Pi Connect 4** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
