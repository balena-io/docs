...
Enter a fleet name, select the **Revolution Pi Connect 4** device type, choose the _Starter_ [fleet type](../accounts/fleet-types.md), and click **Create new fleet**:
...
Finally, click the **Download balenaOS** button. When the download completes, you should have a zipped image file with a name like `balena-First-Fleet-revpi-connect-4-6.10.24-v17.4.2.img.zip`.
...
* Write the balenaOS file you downloaded to the Revolution Pi Connect 4. We recommend using <a href="https://etcher.balena.io/">Etcher</a>.
