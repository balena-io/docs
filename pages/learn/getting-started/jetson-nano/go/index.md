...
Enter a fleet name, select the **Nvidia Jetson Nano SD-CARD** device type, choose the _Starter_ [fleet type](../../../../../learn/accounts/fleet-types/), and click **Create new fleet**:
