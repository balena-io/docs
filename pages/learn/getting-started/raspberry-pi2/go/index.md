# Getting Started: Raspberry Pi 2 and Go
...
<img style="float: right;padding-left: 10px;" src="/img/raspberry-pi2/raspberry-pi2.webp" width="25%">
...
Enter a fleet name, select the **Raspberry Pi 2** device type, choose the *Starter* [fleet type](/learn/accounts/fleet-types), and click **Create new fleet**:
