...
In order to get balenaOS up and running on your **UP Board**, you need to first set it up to boot from your rather than its internal [eMMC memory](https://www.jedec.org/standards-documents/technology-focus-areas/flash-memory-ssds-ufs-emmc/e-mmc). To do this, you will need to interrupt the boot process and direct the device to boot from your .
