...
To create your first application simply type in a name, select the `Odroid C1` as your device type in the drop down and tap create which will take you to your new application's dashboard:-
