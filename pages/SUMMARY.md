...
* [deploy](learn/deploy/README.md)
  ...
  * [Deploy with \{{ $names.company.lower \}} button](learn/deploy/deploy-with-balena-button.md)
...
* [more](learn/more/README.md)
  * [Anti-patterns, or how to break your \{{ $names.os.lower \}} devices](learn/more/anti-patterns.md)
  * [Data collected by \{{ $names.company.lower \}}](learn/more/collected-data.md)
  * [Balena Glossary](learn/more/glossary.md)
  * [examples](learn/more/examples/README.md)
    * [\{{ $names.blocks.lower \}} built for \{{ $names.cloud.lower \}}](learn/more/examples/balenablocks.md)
    * [\{{ $names.company.upper \}} example projects](learn/more/examples/example-projects.md)
    * [Projects built on \{{ $names.company.lower \}}](learn/more/examples/labs-projects.md)
  * [masterclasses](learn/more/masterclasses/README.md)
    * [\{{ $names.company.upper \}} Masterclasses](learn/more/masterclasses/masterclass-intro.md)
...
* [OS](reference/os/README.md)
  ...
  * [Networking on \{{ $names.os.lower \}}](reference/OS/network.md)
  * [What is \{{ $names.os.lower \}}?](reference/OS/overview.md)
  ...
  * [updates](reference/os/updates/README.md)
    ...
    * [What happens during a \{{ $names.company.lower \}} host OS update?](reference/OS/updates/update-process.md)
...
* [sdk](reference/sdk/README.md)
  * [\{{ $names.company.upper \}} SDK deprecation policy](reference/sdk/deprecation-policy.md)
