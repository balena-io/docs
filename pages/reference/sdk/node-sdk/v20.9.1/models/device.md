...
```
## getOsUpdateStatus
**balena.models.device.getOsUpdateStatus(uuid) ⇒ <code>Promise</code>~~**
...
```
## getApplicationInfo
**balena.models.device.getApplicationInfo(uuidOrId) ⇒ <code>Promise</code>~~**
...
```
## startApplication
**balena.models.device.startApplication(uuidOrId) ⇒ <code>Promise</code>~~**
...
```
## stopApplication
**balena.models.device.stopApplication(uuidOrId) ⇒ <code>Promise</code>~~**
