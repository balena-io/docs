...
```
## generateApiKey
**balena.models.application.generateApiKey(slugOrUuidOrId) ⇒ <code>Promise</code>~~**
...
**balena.models.application.generateProvisioningKey(slugOrUuidOrId, [keyName], [keyDescription], [keyExpiryDate]) ⇒ <code>Promise</code>**
