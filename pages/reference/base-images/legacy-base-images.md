...
__Warning:__ All `resin/...` base images are **DEPRECATED** in favor of the newer set of images under the namespace [`balenalib`](https://hub.docker.com/u/balenalib/). For information on migrating to these new images checkout ["Migrating to balenalib base images"]()
