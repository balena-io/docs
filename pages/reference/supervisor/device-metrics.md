...
You can also fetch device metrics data through balena's [open API](../../../reference/api/overview/), [Node SDK](../../../reference/sdk/node-sdk/), and [Python SDK](../../../reference/sdk/python-sdk/). This allows you to port metrics data to a custom dashboard in order to monitor the utilization and health of your fleet. Note that device metrics are available with balenaOS v2.56.0+rev1 and higher, running Supervisor v11.14.0 and higher.
