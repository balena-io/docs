...
| `RESIN_HOST_ODMDATA_configuration` | Define the ODMDATA configuration to configure UPHY lanes. Only supported by supervisor versions &gt;&#x3D; v11.13.0. | Yes | integer | 2 | 
| `RESIN_HOST_EXTLINUX_fdt` | Define the file name of the DTB to be used. Only supported by supervisor versions &gt;&#x3D; v11.14.2. | Yes | string |  | 
