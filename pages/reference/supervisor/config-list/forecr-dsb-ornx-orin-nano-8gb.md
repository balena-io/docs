...
| `BALENA_HOST_CONFIG_fan_profile` | Define the device fan profile. Supported by OS with Jetpack 6 or higher. Only supported by supervisor versions &gt;&#x3D; v17.1.2. | Yes | string |  | 
