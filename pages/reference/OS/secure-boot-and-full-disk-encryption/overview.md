...
__Note:__ We are aware that balena owned keys might not fit all use cases. Unique customer keys can also be provided as an extra service. Contact [sales@balena.io](mailto:sales@balena.io) to discuss [custom hardware support](https://www.balena.io/pricing/#custom-device-support) packages.
