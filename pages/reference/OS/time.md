...
You can configure your own NTP servers in the [`config.json` file](../../../reference/OS/configuration/#ntpservers) location in the [boot partition](../../../reference/OS/overview/2.x#image-partition-layout). For example:
