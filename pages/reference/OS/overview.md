...
<figure><img src="../../../summary/.gitbook/assets/balenaOS-components.webp" alt=""><figcaption></figcaption></figure>
...
In order to improve the [development experience](../../learn/develop/local-mode.md) of balenaOS, there is an [Avahi](https://wiki.archlinux.org/index.php/Avahi) daemon that starts advertising the device on boot as `<short-UUID>.local` or `<hostname>.local` if the hostname is set. Avahi listens on UDP port `5353` for mDNS traffic. It also uses ephemeral (“random”) ports to receive replies to unicast DNS queries.
...
<figure><img src="../../../summary/.gitbook/assets/image-partition-layout.webp" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../summary/.gitbook/assets/read-only-rootfs.webp" alt=""><figcaption></figcaption></figure>
