...
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| poky/meta                                  | [https://git.yoctoproject.org/poky/tree/meta](https://git.yoctoproject.org/poky/tree/meta)                                                                                               | Poky build tools and metadata.                                            |
| poky/meta-poky                             | [https://git.yoctoproject.org/poky/tree/meta-poky](https://git.yoctoproject.org/poky/tree/meta-poky)                                                                                     |                                                                           |
